...
let
  ...
  hashMap = {
    x86_64-linux = "sha256-8+QPjIKWCnEwIds5grEJK9mz7gJD3AWliL30zooyCgY="; # desktop-amd64
    aarch64-linux = "sha256-MdfhefOMyDr9ocEkpW9xHyrnYocbscN0kJYLsqS5csI="; # desktop-arm64
  };
