...
let
  ...
  hashMap = {
    x86_64-linux = "sha256-XVFJBXZ0OIxz87im0+d2y6b6dbJlNkgtvwP/blPU/CY="; # desktop-amd64
    aarch64-linux = "sha256-CRFxHjZUay9rjt7qtdpILQ3LBj+UgHPdBgYxNcO/+lU="; # desktop-arm64
  };
