...
let
  ...
  hashMap = {
    x86_64-linux = "sha256-f3M3UYbFYbxPRpKoITp9KwGHALHvw/vMZHrP6ICmAa8="; # desktop-amd64
    aarch64-linux = "sha256-2XUDTW3GFlFjX+P5YgBScWhHH5B3AmjTo6KIuPsfJwM="; # desktop-arm64
  };
