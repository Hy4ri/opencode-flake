...
let
  ...
  hashMap = {
    x86_64-linux = "sha256-56j/UE0tkX/P2R+j3Rj9UmtSkr13/iJhxxwsY8Np4Ko="; # desktop-amd64
    aarch64-linux = "sha256-7hao+FVZiZkMDuAcSZp1QINV8fE+7QRdMyQt+Spq+v4="; # desktop-arm64
  };
