...
let
  ...
  hashMap = {
    x86_64-linux = "sha256-EltiWIaoQfnI/Z5AL48b+LFKbghEbTE7wKDfxpMzVpc="; # desktop-amd64
    aarch64-linux = "sha256-MnFF/CxTI890IDm5qYGUAXTXKTN4WU81d4bQ0wNBY+k="; # desktop-arm64
  };
