...
let
  ...
  hashMap = {
    x86_64-linux = "sha256-9/lHjOIYbCbU/VltszMYkDyWp1FhCU2R8gRnuvAzJes="; # desktop-amd64
    aarch64-linux = "sha256-KHni66nN+hZ+e6lrlCkKEygMhaQZeAKCEHGujL2/MUg="; # desktop-arm64
  };
