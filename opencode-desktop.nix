...
let
  ...
  hashMap = {
    x86_64-linux = "sha256-yVG+oLpb0vYXnt+lRTXHkBsXNOwtPazHi8LxuCUz1D8="; # desktop-amd64
    aarch64-linux = "sha256-BIWTvgldyW3JToO7FyYt22Fq+slIINWcAarjJ8aI4+o="; # desktop-arm64
  };
