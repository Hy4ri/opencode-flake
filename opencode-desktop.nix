...
let
  ...
  hashMap = {
    x86_64-linux = "sha256-+SJyzK0BufGihqZOVBVVuLqq2cIVnm6APvbY0+bFeBk="; # desktop-amd64
    aarch64-linux = "sha256-ErMCDEJ4NLKELP5o80WR30Tmi4kOPoDiwuhqWbO0zgc="; # desktop-arm64
  };
