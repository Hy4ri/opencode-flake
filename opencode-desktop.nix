...
let
  ...
  hashMap = {
    x86_64-linux = "sha256-4zdvqCaKAHt3h4RbmGODL1AOgtrvVx7GzJ/EclpCgQg="; # desktop-amd64
    aarch64-linux = "sha256-KXalzezlU+RJctG082scjukFAQUGesmC1HbWtRyK2sc="; # desktop-arm64
  };
