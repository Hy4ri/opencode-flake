...
let
  ...
  hashMap = {
    x86_64-linux = "sha256-jBGtMS5lpJWVXe+KzQgRSho8BcaEzGvONzIbAWled0w="; # desktop-amd64
    aarch64-linux = "sha256-TnNDSOSUUQhdBf4DcNOU6xULBD0f4sO/wP2vKhxEGh0="; # desktop-arm64
  };
