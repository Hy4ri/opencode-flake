...
let
  ...
  hashMap = {
    x86_64-linux = "sha256-C0O/FpJQZvxFrVAk+cHg5Ln2lBvZXOLCigs28D191EA="; # desktop-amd64
    aarch64-linux = "sha256-qXR9w5S6RSfCJLMviWHTj62QVq3e+pY+4bsBT9Nwfm4="; # desktop-arm64
  };
