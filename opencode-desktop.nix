...
let
  ...
  hashMap = {
    x86_64-linux = "sha256-T7B5VtRrEbAoCAPvrmngUP6bwz1yVBwwzxoaP9qrzEY="; # desktop-amd64
    aarch64-linux = "sha256-dzAdtB1QaOAR6V8OAWnTX2U/U39+yoHmQintNpS0+xc="; # desktop-arm64
  };
