...
let
  ...
  hashMap = {
    x86_64-linux = "sha256-8bgyEz+xKpvkNBbrNVhpY9aAc4l3qKldHaCAKjbk1d4="; # desktop-amd64
    aarch64-linux = "sha256-jh5p7Pz+M/kVaDxVf4ddBFuF1OTPlz8X9ukJcjKla3Y="; # desktop-arm64
  };
