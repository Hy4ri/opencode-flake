...
let
  ...
  hashMap = {
    x86_64-linux = "sha256-QYWvh6gWt3gKTZ2Z9VSWWwF7YsRz45NwG6thE4NVRII="; # desktop-amd64
    aarch64-linux = "sha256-DehK+B0H8pbpuv54KhK4F6ZtUQgDbQEGZx/VwLCqqWo="; # desktop-arm64
  };
