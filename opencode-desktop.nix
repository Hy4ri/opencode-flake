...
let
  ...
  hashMap = {
    x86_64-linux = "sha256-pnvEepje0QJ156jzL6PhZIC1WZbNUiMtqRRQQytNZZk="; # desktop-amd64
    aarch64-linux = "sha256-Cb0r6ZUbpaejM9uBjeSVJO3GyY/tzKINE6Sg8cbFueE="; # desktop-arm64
  };
