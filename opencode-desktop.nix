...
let
  ...
  hashMap = {
    x86_64-linux = "sha256-6cS9+INmwemq4JKTPOyTiGDh1Q3LNjK5un4oq5DDlBo="; # desktop-amd64
    aarch64-linux = "sha256-x2jxO9nWEHj31ou/qbNPgk8jKHaCwZYj1J3EvUaHynY="; # desktop-arm64
  };
