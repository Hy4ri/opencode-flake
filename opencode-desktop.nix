...
let
  ...
  hashMap = {
    x86_64-linux = "sha256-uyOcRYkoowimkop1JbNpc2nG+d1HjC9dunvxSZbLLZ8="; # desktop-amd64
    aarch64-linux = "sha256-V5LJqsPtCGoERjZEc998pN9/D+QZCQOpVjd/coJ9bpY="; # desktop-arm64
  };
