...
let
  ...
  hashMap = {
    x86_64-linux = "sha256-5HOMXYg39T7EN4FAM6GNAZdyq5nyxGWFBfxydrEwP+c="; # desktop-amd64
    aarch64-linux = "sha256-bCUuqSkiyKyNZmrKndKJrSLdskVpWQUPydqZvWBeqOI="; # desktop-arm64
  };
